...
('Calibration Issue', 'Are you having trouble getting calibrated? ', '<a href=\"selfhelpresource.php?Title=Interactive Help\" accesskey = \"y\"></a>\r\n<br>\r\nUse the Yes Option if you cannot hit a calibration Point or are asked to repeat ', '<a href=\"selfhelpresource.php?Title=Eye Image\" accesskey = \"n\"></a>\r\n<br>\r\nUse the No Option if you can hit a calibration Point  ', 1, '', ''),
('Eye Image', 'Do you see your Eye Image?', '<a href=\"selfhelpresource.php?Title=Hitting Target\" accesskey = \"y\">Yes</a>\r\n', '<a href=\"selfhelpresource.php?Title=Hitting Target\" accesskey = \"n\">No</a>', 1, NULL, NULL),
