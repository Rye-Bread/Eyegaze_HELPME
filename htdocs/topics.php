...
/////////////////////////////////////////////////////After this line you can use row[] variables.
	...
	echo "<br>";
	echo "<div id='templateSteps' class='stepsBody'>$row[2]</div>";
	echo "<br><br>";
	//The next block shows how you can get the image path from the database and display an image.
	echo "<div id='templateImg' class='imageBody'><img src= '$row[4]' alt= 'sample image'></div>";
	echo "<br><br>";
	//This next block shows how you can use the optional images, but only if they exist:
	if ($row[5] != NULL)
	{
	echo "<div id='templateImg' class='imageBody'><img src= '$row[5]' alt= 'sample image'></div>";
	}
