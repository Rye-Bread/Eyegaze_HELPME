...
<body>
  ...
  <br>
	...
	<div id="IndexBody" class="IndexPage">
		...
		<h2> Please select either the FAQ or the Interactive Help Tool using your Grid bar </h2>
    <div id = "IndexOptions" class="IndexPage">
      <a href="faqsmainpage.php" accesskey="a">FAQ</a>
      <br><br>
    ...
    <div id = "IndexOptions" class="IndexPage">
      <a href="selfhelpresource.php?Title=Interactive%20Help" accesskey="b">Interactive Help Tool</a>
      <br><br>
